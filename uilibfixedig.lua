...
function Creator.GetThemeProperty(Property)
	local themeName = Library.Theme or Creator.Theme or "Dark"
	local theme = Themes[themeName] or Themes.Dark
	return theme[Property] or Themes.Dark[Property]
end

function Creator.ApplyThemeToObject(Instance, Object)
	if not Instance or not Object or type(Object.Properties) ~= "table" then
		return
	end
...
function Creator.UpdateTheme()
	for Instance, Object in next, Creator.Registry do
		if typeof(Instance) == "Instance" and Instance.Parent == nil and not Instance:IsDescendantOf(game) then
			Creator.Registry[Instance] = nil
		else
			Creator.ApplyThemeToObject(Instance, Object)
		end
	end
	...
	if transparency ~= nil then
		for Idx = #Creator.TransparencyMotors, 1, -1 do
			local Motor = Creator.TransparencyMotors[Idx]
			if Motor then
...
function Creator.AddThemeObject(Object, Properties)
	...
	Creator.ApplyThemeToObject(Object, Data)
