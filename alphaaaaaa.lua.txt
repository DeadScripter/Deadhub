...
Components.Tab = (function()
    ...
    local Tab = {
        ...
        Name = Title,
        Type = "Tab",
        Premium = (PremiumFlag == true or PremiumFlag == "true") -- ✅ store it here
    }
...
Components.Window = (function()
    ...
    if TabConfig.premium and not getgenv().premiumuser then
        ...
        Tab:AddParagraph({
            Title = "Premium Only",
            Content = "This tab is premium only.\nJoin our Discord server to unlock it and get all the crazy features!"
        })

        -- disable all element functions so nothing else shows
...
local MinimizeButton = New("TextButton", {
    ...
    New("ImageLabel", {
        Image = chosenIcon,
        BackgroundTransparency = 1,
        Size = UDim2.new(1.09, 1.15, 1.09, 1.15), -- fills parent
